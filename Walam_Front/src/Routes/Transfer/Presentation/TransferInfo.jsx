...
export default function TransferInfo () {
  ...
  const validationSchema = Yup.object().shape({
    ...
    cvu: Yup.number()
      .max(12, 'CVU debe tener 12 números')
      .required('El CVU es requerido'),
    cantidad: Yup.number()
  ...
  return (
    <div className='flex flex-col px-8'>
      <IoEllipsisVerticalCircle className='text-black text-2xl self-end' />
      ...
      >
        {({ errors, values }) => (
          <Form className='rounded pt-6 h-[280px]'>
            {/* Form inputs */}
